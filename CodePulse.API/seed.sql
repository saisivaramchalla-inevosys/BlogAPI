...
',
    ...
    'sivaram',
    '2023-06-14T07:40:10.956'::timestamp,
    true
);
...
INSERT INTO "BlogPosts" (
    ...
    '908ba10a-f3cd-4918-8c8b-08db6cab4598'::uuid,
    'Building a Simple Web API Using C# and .NET Core: A Step-by-Step Guide',
    'Building a robust and efficient web API is a fundamental skill for modern application development. In this comprehensive guide, we will walk you through the process of creating a simple web API using C# and .NET Core.',
    '## Introduction
...
',
    'https://images.pexels.com/photos/7367/startup-photo.jpg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    'web-api-csharp',
    'sivaram',
    '2023-06-14T07:45:30.041'::timestamp,
    true
);
...
INSERT INTO "BlogPosts" (
    ...
    '9449dc77-3fc4-4b72-8c8c-08db6cab4598'::uuid,
    'Reading an Excel File in C#: A Step-by-Step Guide',
    'Reading data from Excel files is a common requirement in many applications. In this comprehensive guide, we will walk you through the process of reading an Excel file in C# using the .NET framework',
    '## Introduction
...
',
    ...
    'read-excel-csharp',
    'sivaram',
    '2023-06-14T07:48:27.031'::timestamp,
    true
);
...
INSERT INTO "BlogPosts" (
    ...
    '061265f3-cdfb-428f-8c8d-08db6cab4598'::uuid,
    'Building a Simple Navigation Bar: A Step-by-Step Guide',
    'A navigation bar is an essential component of any website or web application, providing users with easy access to different sections and pages.',
    '## Introduction
...
',
    'https://images.pexels.com/photos/109371/pexels-photo-109371.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    'simple-navigation-bar',
    'sivaram',
    '2023-06-14T07:51:14.476'::timestamp,
    true
);
...
INSERT INTO "BlogPosts" (
    ...
    'f02bb5b2-1bb3-44f6-7267-08db615ccdfb'::uuid,
    'Creating an Interactive HTML Website with ChatGPT: Enhancing User Engagement',
...
',
    'https://images.pexels.com/photos/16037283/pexels-photo-16037283/free-photo-of-open-laptop-on-desk.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    'html-website-using-chatgpt',
    'sivaram',
    '2023-05-30T22:35:50.623'::timestamp,
    true
);
...
INSERT INTO "BlogPosts" (
    ...
    '81495368-62a1-434c-7268-08db615ccdfb'::uuid,
    'Creating a Simple Calculator Application using ASP.NET Core Console App',
